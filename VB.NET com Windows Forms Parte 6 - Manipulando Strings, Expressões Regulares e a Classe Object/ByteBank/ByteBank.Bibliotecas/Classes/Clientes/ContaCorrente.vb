...
#Region "CONSTRUTORES"
        ...
        ''' <summary>
        ''' Este contrutor instancia uma nova classe ContaCorrente. Devemos passar como parâmetro os números de Agência e Conta.
        ''' </summary>
        ''' <param name="CodigoAgencia">Representa o número da agência expresso em número inteiro. Deve ser maior que zero. Ele será atribuído à propriedade <see cref="agencia"/>.</param>
        ''' <param name="NumeroConta">Representa o número da conta expresso em número inteiro. Deve ser maior que zero. Ele será atribuído à propriedade <see cref="numero"/>.</param>
...
#Region "MÉTODOS"
        ...
        ''' </summary>
        ''' <param name="ValorSacado">Valor a ser sacado da conta e será atualizado na propriedade <see cref="saldo"/>. É um integer.</param>
        ...
        ''' <exception cref="ValorSacadoMenorSaldoException">Esta exceção irá acontecer se o valor de <see cref="Saldo"/> for menor que <paramref name="ValorSacado"/>.</exception>
        ...
        Public Overrides Function ToString() As String
            ...
            'Return "Agência: " + agencia.ToString + " e Conta: " + numero.ToString + " e o saldo atual é: " + saldo.ToString

            Return $"Agência: {agencia} - Conta: {numero} - Saldo: R${saldo}"
