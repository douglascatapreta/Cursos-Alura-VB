Public Class Frm_Principal01
    ...
    Private Sub ContasCorrentesAgênciaToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ContasCorrentesAgênciaToolStripMenuItem.Click
        Dim F As New Frm_ContasCorrentesAgencia
        F.MdiParent = Me
        F.Show()
    End Sub

    Private Sub ContasCorrentesAgênciaDicToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ContasCorrentesAgênciaDicToolStripMenuItem.Click
